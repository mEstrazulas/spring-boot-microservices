package br.com.unimedfortaleza.portal.oauth.model;
...
public class User implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "oauth_user_authority", joinColumns = @JoinColumn(name = "username"), inverseJoinColumns = @JoinColumn(name = "authority"))
